...
Fleet Management Software-->Vehicle Worksop Software: ask for available documents in period (JWT)
Vehicle Worksop Software-->Fleet Management Software: sending available document ids(JWT)
Fleet Management Software-->Vehicle Worksop Software: get available document by id(JWT)
